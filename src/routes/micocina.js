...
/*if(client){
    console.log('Twilio esta conectado');
}else{
    console.log('Twilio no esta conectado');
}*/
...
const verificarFechas = function(productos,phone){
    ...
    if(productos.length){
        productos.forEach(producto => {
            ...
            console.log('Prueba funcional, la diferencia de dias es de: ' + restaFechas(fechaHoy,fechaPro));

            if((restaFechas(fechaHoy,fechaPro)<=30) && (restaFechas(fechaHoy,fechaPro)>0)){
                let diasRestantes = restaFechas(fechaHoy,fechaPro);
                //console.log('Falta ' + diasRestantes + ' dias');
